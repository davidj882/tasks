    ...
    <div class="col-md-12">
      	<div class="box box-info">
            <div class="box-header with-border">
              	<h3 class="box-title">Rel Enterprise User Edit</h3>
            </div>
			<?php echo form_open('rel_enterprise_user/edit/'.$rel_enterprise_user['id']); ?>
			<div class="box-body">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="enterprise_id" class="form-control">
								...
								{
									$selected = ($enterprise['id_enterprise'] == $rel_enterprise_user['enterprise_id']) ? ' selected="selected"' : "";
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="user_id" class="form-control">
								...
								{
									$selected = ($user['id_user'] == $rel_enterprise_user['user_id']) ? ' selected="selected"' : "";
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="role_id" class="form-control">
								...
								{
									$selected = ($role['id_role'] == $rel_enterprise_user['role_id']) ? ' selected="selected"' : "";
