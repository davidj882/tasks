    ...
    <div class="col-md-12">
      	<div class="box box-info">
            <div class="box-header with-border">
              	<h3 class="box-title">Rel Roles Permission Add</h3>
            </div>
            <?php echo form_open('rel_roles_permission/add'); ?>
          	<div class="box-body">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="permission_id" class="form-control">
								...
								{
									$selected = ($permission['id_permission'] == $this->input->post('permission_id')) ? ' selected="selected"' : "";
