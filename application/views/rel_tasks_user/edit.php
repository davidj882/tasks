    ...
    <div class="col-md-12">
      	<div class="box box-info">
            <div class="box-header with-border">
              	<h3 class="box-title">Rel Tasks User Edit</h3>
            </div>
			<?php echo form_open('rel_tasks_user/edit/'.$rel_tasks_user['id']); ?>
			<div class="box-body">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="task_id" class="form-control">
								...
								{
									$selected = ($task['id_task'] == $rel_tasks_user['task_id']) ? ' selected="selected"' : "";
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="user_id" class="form-control">
								...
								{
									$selected = ($user['id_user'] == $rel_tasks_user['user_id']) ? ' selected="selected"' : "";
